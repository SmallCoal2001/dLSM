...
#define MEMTABLE_SEQ_SIZE 72818 //Make the in memory buffer close to 64MB 1 shard origin
//#define MEMTABLE_SEQ_SIZE 19231 //Make the in memory buffer close to 64MB
//#define MEMTABLE_SEQ_SIZE 38462
// 8 shard's memtable size X 8  shoul d be a little larger that the memtable of 64MB,
